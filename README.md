...
The `install.sh` script was tested on [images](https://github.com/pyavitz/rpi-img-builder/releases/tag/image) built with the [rpi-img-builder](https://github.com/pyavitz/rpi-img-builder). I can't say with any certainty, it will work with an official Ubuntu Focal release.
